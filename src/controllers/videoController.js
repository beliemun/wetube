...
export const postUpload = async(req, res) => {
    const {
        ...
        files: {
            videoFile: [{ location: videoPath }],
            posterFile: [{ location: posterPath }],
        },
    } = req;
    ...
    req.user.save();
    req.flash("success", "Uploaded your video successfully.");
...
export const postEditVideo = async(req, res) => {
    ...
    try {
        ...
        req.flash("success", "Updated your video successfully.");
...
export const deleteVideoDB = async(req, res) => {
    const {
        params: { id },
    } = req;
    ...
    try {
        ...
        if (`${video.creator}` !== req.user.id) {
            ...
            console.log("Delete video DB successfuly!");
        }
    } catch (error) {
        console.log(error);
    }
